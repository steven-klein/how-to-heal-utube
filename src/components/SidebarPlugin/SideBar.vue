        ...
        <div class="container-fluid">
            ...
            <div v-show="$sidebar.showSidebar" class="navbar-collapse collapse show" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav mb-md-3">
                    <sidebar-item :link="{name: 'My Channel', icon: 'ni ni-tv-2', path: '/channel'}"/>
                    <sidebar-item :link="{name: 'Favorites', icon: 'ni ni-favourite-28', path: '/dashboard'}"/>
                    <sidebar-item :link="{name: 'Settings', icon: 'ni ni-ui-04', path: '/dashboard'}"/>
                    <!--
                    <li class="nav-item">
                        <a class="nav-link"
                           href="https://demos.creative-tim.com/vue-argon-dashboard/documentation">
                            <i class="ni ni-spaceship"></i> User Channel
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
